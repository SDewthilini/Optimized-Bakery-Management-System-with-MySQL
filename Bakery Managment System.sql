...
SELECT * FROM Customer WHERE Name LIKE 'ni%';
 ...
 -- 8) union operations 
(SELECT * FROM Employee WHERE Position = 'Delivery boy')
union
(SELECT * FROM Employee WHERE salary>50000); 

(SELECT * FROM Transaction WHERE status = 'Delivery')
union
(SELECT * FROM Transaction WHERE Total_Amount>=100); 
...
INTERSECT
SELECT * FROM Customer WHERE name='amal'; 

SELECT * FROM product WHERE Price_of_One_Item >= 100
INTERSECT
...
(SELECT * FROM Employee WHERE Position = "chef") 
EXCEPT
(SELECT * FROM Employee WHERE Branches_ID='B002'); 
...
explain (SELECT * FROM Employee WHERE Position = 'Delivery boy')
union
(SELECT * FROM Employee WHERE salary>50000); 
...
explain (SELECT * FROM Transaction WHERE status = 'Delivery')
union
(SELECT * FROM Transaction WHERE Total_Amount>=100); 
...
explain SELECT * FROM Customer WHERE city = 'kandy'
INTERSECT
SELECT * FROM Customer WHERE name='amal'; 
...
explain SELECT * FROM product WHERE Price_of_One_Item >= 100
INTERSECT
SELECT * FROM product WHERE Stock_Quantity >= 50; 
...
explain (SELECT * FROM Employee WHERE Position = "chef") 
EXCEPT
(SELECT * FROM Employee WHERE Branches_ID='B002'); 
